...
namespace JsonTestServer
{
    class Server
    {
        ...
        private void handleTheRequest(Socket clientSocket)
        {
            ...
            string[] temps = strReceived.Split(new string[] { "\r\n" },StringSplitOptions.RemoveEmptyEntries);
        ...
        {
            sendResponse(clientSocket, "<html><head><meta http - equiv =\"Content-Type\" content=\"text/html; charset = utf - 8\"></ head >< body >< h2 >Simple Web Server </ h2 >< div > 501 - Method NotImplemented </ div ></ body ></ html > ", "501 Not Implemented", "text/html");
        }
